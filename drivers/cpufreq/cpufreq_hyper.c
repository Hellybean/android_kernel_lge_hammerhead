...
static unsigned int skip_hyper = 0;
...
void hyper_boost_cpu(int boost)
{
	int cpu;
...
MODULE_DESCRIPTION("'cpufreq_hyper' - multiphase dynamic cpufreq governor");
MODULE_LICENSE("GPL");
