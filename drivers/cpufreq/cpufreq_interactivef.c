...
static int cpufreq_governor_interactivef(struct cpufreq_policy *policy,
		unsigned int event);

#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_INTERACTIVEF
static
#endif
struct cpufreq_governor cpufreq_gov_interactivef = {
	.name = "interactiveF",
	.governor = cpufreq_governor_interactivef,
...
static int __init cpufreq_interactive_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_interactivef);
}
...
{
	cpufreq_unregister_governor(&cpufreq_gov_interactivef);
